...
A_cpu, B_cpu = generate_nearest_neighbor_matrices(n=n, seed=42)
print("CPU数据准备完毕")
...
#保存到 CSV
output_path = f"/home/lg/ICML2025_project/push_pull_linear/neighbor_out/neighbor_avg_n={n}_gpu_batched.csv"
