...
import cupy as cp
from cupy_fuc import grad_with_batch_batched_gpu, PushPull_with_batch_batched_gpu_new

d = 10
L_total = 1440000
n = 25 # num_nodes
num_runs = 20 # 并行运行的次数
device_id = "cuda:1" # 指定GPU
...
A_cpu, B_cpu = generate_grid_matrices(n=n, seed=42)
print("CPU数据准备完毕")
...
L1_avg_df = PushPull_with_batch_batched_gpu_new(
    A_gpu=A_gpu,
    B_gpu=B_gpu,
...
#保存到 CSV
output_path = f"/home/lg/ICML2025_project/push_pull_linear/NEW_out/GRID_new_new_GRID_avg_n={n}_gpu_batched.csv"
