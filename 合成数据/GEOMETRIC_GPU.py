...
A_cpu, B_cpu = generate_topology_matrices("ring", n=n, matrix_seed=42, k=2)
print("CPU数据准备完毕")
...
output_path = f"/home/lg/ICML2025_project/push_pull_linear/GEOMETRIC_out/GEOMETRIC_avg_n={n}_gpu_batched.csv"
